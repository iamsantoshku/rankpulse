...
//   { title: "Mock Test", path: "/exams", icon: FileText },
//   { title: "Free Mock Test", path: "/exams", icon: Zap },
//   { title: "Live Test", path: "/live-test", icon: Clock, highlight: true },
//   { title: "Free Test", path: "/free-test", icon: BarChart },
//   { title: "Daily Quiz", path: "/daily-quiz", icon: BookOpen },
//   { title: "Typing Test", path: "/typing-test", icon: Keyboard },
//   { title: "Previous Year Paper", path: "/pyp", icon: Layers },
//   { title: "Current Affairs", path: "/current-affairs", icon: Newspaper },
//   { title: "Study Notes", path: "/study-notes", icon: Book },
//   { title: "Practice Batch", path: "/practice-batch", icon: FileText },
// ];
