...
// import { getQuestionsByTest } from "../services/test.service";
...
//       {/* CONTAINER */}
//       <div className="bg-white border rounded shadow p-6 max-w-5xl mx-auto">
...
//             <li>Duration: <b>60 minutes</b></li>
//             <li>Total Questions: <b>{questions.length}</b></li>
//             <li>Negative Marking: <b>25%</b></li>
//             <li>Sections: <b>4</b></li>
//           </ul>
...
//                   <td className="border p-2">Reasoning</td>
//                   <td className="border p-2">25</td>
//                   <td className="border p-2">50</td>
//                 </tr>
...
//           <ul className="list-disc ml-5 text-sm space-y-1">
//             <li>Timer will be shown on top right</li>
//             <li>Test auto submits after time ends</li>
//             <li>No manual submission needed</li>
//           </ul>
...
//           <ul className="list-disc ml-5 text-sm space-y-1">
//             <li>Duration: <b>{test.duration} minutes</b></li>
//             <li>Total Questions: <b>{questions.length}</b></li>
//             <li>Total Marks: <b>{questions.length * 2}</b></li>
//             <li>Negative Marking: <b>25%</b></li>
//           </ul>
